...
class TestElasticsearchDBI(unittest.TestCase):
    ...
    def tearDown(self) -> None:
        ...
        @return: None
        """
        if self.es.index_exists(self.test_index_name):
            self.es.delete_index(self.test_index_name)
        self.es = None
    ...
    def test_create_index(self) -> None:
        ...
        if self.es.index_exists(self.test_index_name):
            self.es.delete_index(self.test_index_name)
        self.assertTrue(self.es.create_index(self.test_index_name))
    ...
    def test_index_exists(self) -> None:
        ...
        self.assertFalse(self.es.index_exists('inexistent_index_name'))
    ...
    def test_delete_index(self) -> None:
        ...
        if not self.es.index_exists(self.test_index_name):
            self.es.create_index(self.test_index_name)
        self.assertTrue(self.es.delete_index(self.test_index_name))
    ...
    def test_add_index_settings(self) -> None:
        ...
        self.es.add_index_settings(index=self.test_index_name, settings=settings)
    ...
    def test_put_mapping(self) -> None:
        ...
        # create temp index
        self.es.create_index(temp_test_index)

        # put mapping
        self.es.put_mapping(index=temp_test_index, mapping=mapping)

        # insert valid document
        self.assertTrue(self.es.create_document(index=temp_test_index, _id=1, document={"some_string": "Hello",
                                                                                        "some_bool": True}))

        # try insert malformed document
        self.assertFalse(self.es.create_document(index=temp_test_index, _id=1, document={"some_string": 100,
                                                                                         "some_bool": "not_bool"}))
        # delete temp index
        self.es.delete_index(temp_test_index)
    ...
    def test_create_document(self) -> None:
        ...
        if not self.es.index_exists(self.test_index_name):
            self.es.create_index(self.test_index_name)
        document_id = self.es.create_document(index=self.test_index_name, _id='test_id', document={'test': 'value'})
    ...
    def test_get_by_id(self) -> None:
        ...
        document_id = self.es.create_document(index=self.test_index_name, _id='test_id', document={'test': 'value'})
        es_document = self.es.get_document_by_id(index=self.test_index_name, _id=document_id)
    ...
    def test_update_document(self) -> None:
        ...
        document_id = self.es.create_document(index=self.test_index_name, _id='test_id', document={'test': 'value'})
        updated = self.es.update_document(index=self.test_index_name, _id=document_id, document={'test': 'new_value'})
        self.assertTrue(updated)
        updated_document = self.es.get_document_by_id(index=self.test_index_name, _id=document_id)
    ...
    def test_delete_document(self) -> None:
        ...
        deleted = self.es.delete_document(index=self.test_index_name, _id=document_id)
        self.assertTrue(deleted)
        deleted_document = self.es.get_document_by_id(index=self.test_index_name, _id=document_id)
    ...
    def test_mget_by_id(self) -> None:
        ...
        document_id_1 = self.es.create_document(index=self.test_index_name, _id='test_id', document={'test': 'value'})
        document_id_2 = self.es.create_document(index=self.test_index_name, _id='test_id2', document={'test': 'value2'})
        documents = self.es.mget_documents_by_id(index=self.test_index_name, ids=[document_id_1, document_id_2])
    ...
    def test_search_documents(self) -> None:
        ...
        self.assertTrue(self.es.create_document(index=self.test_index_name,
                                                _id='test_id',
                                                document={'score': 100},
                                                refresh=True))
        self.assertTrue(self.es.create_document(index=self.test_index_name,
        ...
        # existing document
        searched_documents = self.es.search_documents(index=self.test_index_name, query_body={
    ...
    def test_scroll_search_documents(self) -> None:
        ...
        self.assertTrue(self.es.create_document(index=self.test_index_name,
                                                ...
                                                document={'test': 'value'},
                                                refresh=True))
        for es_doc in self.es.scroll_search_documents_generator(index=self.test_index_name):
    ...
    def test_bulk(self) -> None:
        ...
        success, failed = self.es.bulk(actions=actions, chunk_size=len(actions))
