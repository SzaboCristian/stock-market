...
class TestInvestmentCalculatorAPI(unittest.TestCase, InterfaceTestAPI):
    ...
    def test_bad_params(self) -> None:
        ...
        """
        status, data, msg = InvestmentCalculatorAPI.compute_compound_interest(starting_amount="string",
    ...
    def test_valid_params(self) -> None:
        ...
        """
        # positive return
        status, data, msg = InvestmentCalculatorAPI.compute_compound_interest(starting_amount=10000,
                                                                              yearly_return_rate=10,
                                                                              investment_length_in_years=10,
                                                                              additional_yearly_contribution=1000)
        expected_result = {'starting_amount': 10000, 'additional_contribution': 10000,
                           'compound_interest': 21874.849202000027, 'final_amount': 41874.84920200003}
        ...
        status, data, msg = InvestmentCalculatorAPI.compute_compound_interest(starting_amount=10000,
                                                                              ...
                                                                              investment_length_in_years=5,
                                                                              additional_yearly_contribution=1000)
        expected_result = {'starting_amount': 10000, 'additional_contribution': 5000,
                           'compound_interest': -1156.8318720000025, 'final_amount': 13843.168127999998}
